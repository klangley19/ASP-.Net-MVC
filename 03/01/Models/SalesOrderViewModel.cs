...
namespace _01.Models
{
    public class SalesOrderViewModel
    {
        ...
        #region public static DataSourceResult GetOrdersBySalesPerson(int? SalesPersonID, [DataSourceRequest]DataSourceRequest request)
        public static DataSourceResult GetOrdersBySalesPerson(int? SalesPersonID, [DataSourceRequest]DataSourceRequest request)
        {
                ...
                using (AdventureWorksContext db = new AdventureWorksContext())
                {
                    ...
                    DataSourceResult result = db.
                        SalesOrderHeaders
                            ...
                            .OrderBy(o => o.SalesOrderNumber).ToDataSourceResult(request, order => new SalesOrderViewModel
                        {
