...
namespace _01.Models
{
    public class SalesPersonViewModel
    {
        ...
        #region public static DataSourceResult GetSalesPeople([DataSourceRequest]DataSourceRequest request)
        public static DataSourceResult GetSalesPeople([DataSourceRequest]DataSourceRequest request)
        {

            using (AdventureWorksContext db = new AdventureWorksContext())
            {
                IQueryable<vSalesPerson> salespeople = db.vSalesPersons;
                DataSourceResult result = salespeople.ToDataSourceResult(request, sales_people => new SalesPersonViewModel
                {
